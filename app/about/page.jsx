        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside space-y-4 pl-4">
            <li className="text-justify">
              <strong>Comprehensive Movie Database:</strong> Explore thousands of free movies from various decades and genres. Find popular, currently airing, upcoming, and top-rated films all in HD quality.
            </li>
            <li className="text-justify">
              <strong>In-depth TV Series Information:</strong> We don't forget about TV series lovers. Find popular, currently airing, on-air, and top-rated series available for free streaming.
            </li>
            <li className="text-justify">
